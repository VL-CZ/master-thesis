\chapter{Analysis}
This chapter contains further analysis of the topic.
Firstly, it's important to mention that .NET is a managed environment, so the documentation generators can be classified into 2 categories depending on what their input is:
...
Since our generator will use the assembly, we'll describe the compilation process in .NET in a little bit more detail.
