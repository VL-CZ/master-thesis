...
\newtheorem*{requirement*}{Requirement}
\newtheorem{subrequirement}{Requirement}[requirement] % [requirement] makes it a subtheorem

\renewcommand{\therequirement}{R\arabic{requirement}}

\newcounter{subrequirementcounter} % Counter for subrequirements
\renewcommand{\thesubrequirement}{R\arabic{subrequirementcounter}.\arabic{subrequirement}} % Subrequirements will have 1.1, 1.2, etc.

\newtheoremstyle{goal}%
  {10pt}% Space above
  {10pt}% Space below
  {\color{Brown}}% Body font
  {}% Indent amount
  {\bfseries\color{Brown}}% Theorem head font
  {\textcolor{Brown}{:}}% Punctuation after theorem head
  {.5em}% Space after theorem head
  {}% Theorem head spec
\theoremstyle{goal}
\newtheorem{goal}{Goal}
...
\renewcommand{\thegoal}{G\arabic{goal}}
